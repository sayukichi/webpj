...
//  /_/_/_/_/_/_/_/ 基本設定 /_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/
     ...
     *　%N -> 次の月を表示する際のリンク文字
     */
    clndrVar.captionFormat  = "%L %E %Y %N";
...
function calendar_make(_y, _m)
{
    ...
    return      "<table "+ clndrAttrs.table+ ">"
            ...
            +   "<tr onclick=\"location.href='calendar/e_index.html'\">" + weeks + "<\x2ftr>"
            +   "<\x2fthead>"
            +   "<tbody "+ clndrAttrs.tbody+ " onclick=\"location.href='calendar/e_index.html'\">"
